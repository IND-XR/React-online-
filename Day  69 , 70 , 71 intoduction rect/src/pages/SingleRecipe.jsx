...
const SingleRecipe = () => {
  ...
  const SubmitHandler = (recipe) => {   //Updateing 
  ...
  return recipe ? <div className='w-full flex'>
    ...
    {/* < className='right  w-1/2 p-2'>  */}
     <form className='w-1/2 right p-2' action="" onSubmit={handleSubmit(SubmitHandler)} >
...
{/* // description */}
      ...
      <button className='mt-5 block bg-blue-900 px py-2 rounded ' > Update Recipe </button>
      <button className='mt-5 block bg-red-900 px py-2 rounded ' > Delete Recipe </button>
